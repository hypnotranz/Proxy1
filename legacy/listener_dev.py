...
async def lifespan(app: FastAPI):
    ...
    await register_service(
        RegisterRequest(service_name="get_registered_services", url="http://localhost:8005/get_registered_services"))
            ...
            try:
                while True:
                    ...
                    try:
                        ...
                        logging.error(f"Listener: Error forwarding request to {envelope.endpoint_url}: {str(e)}")
